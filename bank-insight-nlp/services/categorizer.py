...
def categorize_transaction(description: str = "", merchant: str = ""):
    ...
    categories = {
        ...
        "Shopping": [
            ...
            "amazon", "flipkart", "noon", "meesho", "snapdeal", "myntra", "ajio", 
            "nykaa", "tatacliq",
            # Shopping terms
            "shopping", "purchase", "buy", "store", "mall", "mart"
        ],
        
        "Transfers": [
            "upi", "ift", "neft", "imps", "rtgs", "transfer", "sent to", "received from",
            "pay req", "money transfer", "bank transfer", "csh", "cash", "atm", "withdrawal"
        ],
