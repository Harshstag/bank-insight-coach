...
import bank.insight.backend.dto.AiNotification;
import bank.insight.backend.dto.InsightsResponse;
...
public class NotificationService {
    ...
    private static final String LLM_URL = "http://localhost:8080/api/ai/insight";
    ...
    public AiNotification fetchNotification(boolean consent) {
        ...
        InsightsResponse nlpResponse = restTemplate.getForObject(NLP_URL, InsightsResponse.class);

        AiNotification nlpNotification = nlpResponse != null ? nlpResponse.getAiNotification() : null;

        Map<String, Object> signals = nlpResponse != null ? nlpResponse.getSignals() : null;

        if (nlpNotification == null)
            return null;
        ...
        try {
            ...
            AiInsightResponse llm = restTemplate.postForObject(LLM_URL, request, AiInsightResponse.class);
